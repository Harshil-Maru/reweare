        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <label className="bg-green-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-green-700 transition-colors cursor-pointer">
                  <input
                    type="file"
                    multiple
                    accept="image/*"
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {formData.tags.map(tag => (
                  <span key={tag} className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm flex items-center space-x-1">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-green-900 mb-2">Estimated Points</h3>
              ...
              <div className="text-3xl font-bold text-green-600">{estimatedPoints}</div>
            </div>
          </div>
